...
class AppColors {
  ...
  static const primaryColorDark = Color(0xFF61045F);
  ...
  //Emerald
  static const emerald300 = Color(0xFFAA076B);
  ...
  static const MaterialColor kPrimaryColorx = MaterialColor(
    ...
    <int, Color>{
      50: Color(0xFFAA076B),
      100: Color(0xFFAA076B),
      200: Color(0xFFAA076B),
      300: Color(0xFFAA076B),
      400: Color(0xFFAA076B),
      500: Color(0xFFAA076B),
      600: Color(0xFFAA076B),
      700: Color(0xFFAA076B),
      800: Color(0xFFAA076B),
      900: Color(0xFFAA076B),
    },
  );
}
