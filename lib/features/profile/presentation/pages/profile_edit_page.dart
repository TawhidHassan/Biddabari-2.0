      ...
      builder: (controller) {
        return Obx(() {
          return Scaffold(
            ...
            body: controller.circuler.value ? LoadingWidget() :
            Container(
              height: 1.0.sh,
              width: 1.0.sw,
              child: ListView(
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        controller.profileResponse.value!
                                            .user!.name ?? "",
                                        style: boldText(21),),
                                      Text(
                                        controller.profileResponse.value!
                              ...
                              InkWell(
                                onTap: () {
                                  BottomPicker.date(
                                    pickerTitle: Text(
                                        "Set your Birthday"),
                                    buttonSingleColor: AppColors
                                        .primaryColor,
                                    buttonContent: Text("Select",
                                      style: boldText(
                                          14, color: Colors.white),),

                                    onSubmit: (index) {
                                      controller.selectDob.value = index
                                          .toString()
                                          .split(" ")
                                          .first;
                                    },
