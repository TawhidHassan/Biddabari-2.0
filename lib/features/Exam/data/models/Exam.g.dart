...
Exam _$ExamFromJson(Map<String, dynamic> json) => Exam(
      json['id'] as int?,
      json['course_section_id'] as int?,
      json['parent_id'],
      json['content_type'] as String?,
      json['title'] as String?,
      json['exam_mode'] as String?,
      json['exam_duration_in_minutes'] as int?,
      json['class_xm_duration_in_minutes'] as int?,
      json['exam_total_questions'] as String?,
      json['exam_per_question_mark'] as int?,
      (json['exam_negative_mark'] as num?)?.toDouble(),
      json['exam_pass_mark'] as int?,
      json['exam_is_strict'] as int?,
