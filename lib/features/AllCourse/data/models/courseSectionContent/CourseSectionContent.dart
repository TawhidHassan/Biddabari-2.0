...
part 'CourseSectionContent.g.dart';
...
class CourseSectionContent{
  ...
  @JsonKey(name: "has_class_xm",defaultValue: 0)
  num? hasClassXm;
  ...
  factory CourseSectionContent.fromJson(Map<String,dynamic>json)=>
      _$CourseSectionContentFromJson(json);
  Map<String,dynamic>toJson()=>_$CourseSectionContentToJson(this);
}