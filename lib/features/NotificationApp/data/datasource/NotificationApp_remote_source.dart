...
abstract class NotificationAppRemoteSource {
// Future<LoginResponseModel?> login(String email,String deviceToken, String pass, bool isPg);

}


class NotificationAppRemoteSourceImpl implements NotificationAppRemoteSource {
    final ApiMethod apiMethod;
   NotificationAppRemoteSourceImpl({required this.apiMethod});
